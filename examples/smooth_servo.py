...
class SmoothEaseInOutQuad(ServoSmoothBase):
    ...
    def generate(self, tick_t_ms: int):
        ...
        for i in range(1, _ss):
            _x = i / _ss
            yield int(
                _s_v + (2 * _x * _x if _x < 0.5 else 1 - pow(-2 * _x + 2, 2) / 2) * _v
            )
        yield _e_v
...
class SmoothEaseInOutCubic(ServoSmoothBase):
    ...
    def generate(self, tick_t_ms: int):
        ...
        for i in range(1, _ss):
            ...
            yield int(
                _s_v
                + (4 * _x * _x * _x if _x < 0.5 else 1 - pow(-2 * _x + 2, 3) / 2) * _v
            )
        yield _e_v
...
class SmoothEaseInOutQuart(ServoSmoothBase):
    ...
    def generate(self, tick_t_ms: int):
        ...
        for i in range(1, _ss):
            ...
            yield int(
                _s_v
                + (8 * _x * _x * _x * _x if _x < 0.5 else 1 - pow(-2 * _x + 2, 4) / 2)
                * _v
            )
        yield _e_v
...
class SmoothEaseInOutBack(ServoSmoothBase):
    ...
    def generate(self, tick_t_ms: int):
        ...
        for i in range(1, _ss):
            ...
            if _x < 0.5:
                yield int(
                    _s_v + ((pow(2 * _x, 2) * ((_c2 + 1) * 2 * _x - _c2)) / 2) * _v
                )
            else:
                yield int(
                    _s_v
                    + ((pow(2 * _x - 2, 2) * ((_c2 + 1) * (_x * 2 - 2) + _c2) + 2) / 2)
                    * _v
                )
        yield _e_v
